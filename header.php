...
<div class="header">
	<div class="logo">
		<a href="index.php"><img src="icons/logo.png" alt="Chubb_Remote-Site Attendance System"></a>
	</div>
</div>
...
<div class="topnav" id="myTopnav">
	<a href="index.php">All Onsite-Staff</a>
    <a href="ManageUsers.php">Manage Staff</a>
    <a href="UsersLog.php">Staff Attendance</a>
    <a href="devices.php">Add Cards</a>
    <?php  
