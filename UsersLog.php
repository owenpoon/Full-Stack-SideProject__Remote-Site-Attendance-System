...
<section>
  <!--User table-->
    <h1>Welcome, here are the Daily Attendance Record of Onsite-Staff :</h1>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filter Your Attendance Record:</h3>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary attendanceFilter">
                    ...
                    <div class="panel panel-primary attendanceFilter">
                      <div class="panel-heading">
                        ...
                        <div class="time">
                          ...
                          <label for="radio-one" class="timeFilter">Time-in</label>
                          <input type="radio" id="radio-two" name="time_sel" class="time_sel" value="Time_out" />
                          <label for="radio-two" class="timeFilter">Time-out</label>
                        </div>
                      </div>
                      <div class="panel-body">
                ...
                <div class="row mt-4">
                  <div class="col-lg-4 col-sm-12">
                    <label class="filter" for="Fingerprint"><b>Filter By Staff:</b></label>
                    <select class="card_sel filter" name="card_sel" id="card_sel" style="pointer-events: none; -webkit-appearance: none;">
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label class="filter" for="Device"><b>Filter By Staff Department:</b></label>
                    <select class="dev_sel filter" name="dev_sel" id="dev_sel" style="pointer-events: none; -webkit-appearance: none;">
                  ...
                  <div class="col-lg-4 col-sm-12">
                    ...
                    <input type="submit" class="exportFilter" name="To_Excel" value="Export">
                  </div>
                </div>
              </div>
            </div>
